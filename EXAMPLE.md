...
applyTo: '**'
---
● Configured MCP servers: Remember, Consult, Creative_Meditation

 ● Connected to GitHub MCP Server

 > Let's try a nice, vividly hallucinated meditation on the nature of Code.

 ✔ creative_meditate
   └ 🧘 CREATIVE MEDITATION

 ✔ creative_ponder
   └ No insights available to ponder. Please run creative_insight first.
